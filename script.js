<<<<<<< Updated upstream
"strict mode";
// const cookiesMenu = document.querySelector(".cookies-icons");
// const cakesMenu = document.querySelector(".cakes-icons");
// const breadMenu = document.querySelector(".bread-sample");
// const menutypes = document.querySelector(".cakes");
// const cookiestype = document.querySelector(".bakes");

// cakesMenu.addEventListener("click", function () {
//   menutypes.classList.remove("cakes-menu-sample");
//   console.log("ok");
// });
// cookiesMenu.addEventListener("click", function () {
//   cookiestype.classList.remove("cookiessamplemenu");
//   console.log("ok");
// });'
...
questionTwo.addEventListener('click', function(){
  response.classList.remove('response2')
=======
<<<<<<< HEAD
"strict mode";
// const cookiesMenu = document.querySelector(".cookies-icons");
...
questionTwo.addEventListener('click', function(){
  response.classList.remove('response2')
>>>>>>> 170df8a5694db0020a89311f54f7910dbbc55206
>>>>>>> Stashed changes
})